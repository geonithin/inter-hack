            ...
            <div className="max-w-lg w-full p-4 sm:p-8 oxford-edge rounded-2xl sm:rounded-3xl space-y-6 sm:space-y-8 bg-white shadow-2xl">
                ...
                <div className="space-y-4">
                    <button
                        ...
                        type="button"
                        className="w-full flex items-center justify-center gap-3 bg-white border-2 border-oxford/10 py-3.5 sm:py-4.5 rounded-xl sm:rounded-2xl hover:bg-gray-50 transition-all shadow-lg active:scale-95 group"
                    >
                        ...
                        <span className="text-oxford font-black uppercase tracking-widest text-[10px] sm:text-xs">Continue with Google</span>
                    </button>

                    <div className="relative py-4">
                        <div className="absolute inset-0 flex items-center">
                            <div className="w-full border-t border-oxford/10"></div>
                        </div>
                        <div className="relative flex justify-center">
                            <span className="bg-white px-4 text-[9px] sm:text-[10px] font-black text-oxford/30 uppercase tracking-[0.2em]">or use credentials</span>
                        </div>
                    </div>
